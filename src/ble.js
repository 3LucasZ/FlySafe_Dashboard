...
//EDITED THIS SECTION WHICH IS FAULTY -------------------->
function parseData(data, t, encoding) {
  console.log("Parsing raw:", data);
  const type = t ? t.toLowerCase() : "lucas"; //change this line from unit8 to number
  let result;
  let decoder;
  console.log("Parsing data of type:", type);
  switch (type) {
    case "lucas":
      console.log("Grab lucas");
      var d0 = data.getUint8(0);
      var d1 = data.getUint8(1);
      console.log("data 0:", d0);
